...
import {Alert,Image,Button,Box,Text,Modal,ModalOverlay,ModalContent,ModalHeader,ModalFooter,ModalBody,ModalCloseButton,useDisclosure,FormControl,FormLabel,Textarea} from "@chakra-ui/react";
...
<Button mt="2" size="sm" colorScheme="pink" onClick={()=>removeFromBasket(item._id)} >
    Remove from cart
            ...
            <Box mt="10"><Text fontSize="22">Total:{total}$</Text>
            <Button mt="2" size="sm" colorScheme='green' onClick={onOpen}>Order</Button>
      </Box>

      <Modal
      initialFocusRef={initalRef}
      isOpen={isOpen}
      onClose={onClose}
...
<ModalContent>
    ...
    <ModalBody pb={6}>
        <FormControl>
            ...
            <Textarea ref={initalRef} placeholder='Address' value={address} onChange={(e)=>setAddress(e.target.value)}></Textarea>
        </FormControl>
